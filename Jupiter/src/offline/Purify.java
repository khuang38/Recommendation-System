...
public class Purify {
	public static void main(String[] args) {
		...
		MongoDatabase db = mongoClient.getDatabase(MongoDBUtil.DB_NAME);
                             // Switch to log file path
		String fileName = "C:\\Users\\LENOVO USER\\Downloads\\apache-tomcat-9.0.24-windows-x64\\apache-tomcat-9.0.24\\logs\\localhost_access_log.2019-09-28.txt";
		...
		try {
			...
			while ((line = bufferedReader.readLine()) != null) {
				// Sample input: 
				// 73.223.210.212 - - [19/Aug/2017:22:00:24 +0000] "GET /Jupiter/history?user_id=1111 HTTP/1.1" 200 11410
